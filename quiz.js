...
function q1(e)
{
    ...
    if($(this).html()=="None of the above"){ //Line 2
      ques1=1; //Line 3
      score=score+1;
      added1=true;
      console.log(score);
...
function q3(e)
{
  if($(this).html()=="LogisticRegression"){
    ques3=1;
    score=score+1;
    added3=true;
    console.log(score);
...
function q4(e)
{
  if($(this).html()=="The data is noisy and contains overlapping points"){
    ques4=1;
    score=score+1;
    added4=true;
    console.log(score);
...
function q8(e)
{
  if($(this).html()=="The value of the gradient at extrema of a function is always zero"){
    ques8=1;
    score=score+1;
    added8=true;
    console.log(score);
...
$('#submit_button').on('click',function(e){
  ...
  // });
   ...
   $.ajax({
    type: "POST",
    url: '/tutscorner/Clustering_Quiz.php',
    data: {score: score},
